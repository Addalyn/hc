...
public class AbilityMod_ThiefBasicAttack : AbilityMod
{
	...
	protected override string ModSpecificAutogenDesc(AbilityData abilityData)
	{
		...
		desc += PropDesc(m_targeterMaxAngleMod, "[TargeterMaxAngle]", isValid, isValid ? thiefBasicAttack.m_targeterMaxAngle : 0);
		...
		desc += PropDesc(m_laserRangeMod, "[LaserRange]", isValid, isValid ? thiefBasicAttack.m_laserRange : 0);
		desc += PropDesc(m_laserWidthMod, "[LaserWidth]", isValid, isValid ? thiefBasicAttack.m_laserWidth : 0);
		...
		return desc + PropDesc(m_stopOnPowerupHitMod, "[StopOnPowerupHit]", isValid, isValid && thiefBasicAttack.m_stopOnPowerupHit);
	}
}
