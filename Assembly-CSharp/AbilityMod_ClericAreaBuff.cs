...
public class AbilityMod_ClericAreaBuff : AbilityMod
{
	...
	protected override string ModSpecificAutogenDesc(AbilityData abilityData)
	{
		...
		desc += PropDesc(m_extraTpCostPerTurnActiveMod, "[IncludeCaster]", isValid, isValid ? clericAreaBuff.m_extraTpCostPerTurnActive : 0);
		...
		desc += PropDesc(m_extraShieldsPerTurnActive, "[AllyEnergyGainPerTurnActive]", isValid);
