...
public class ClientBootstrap : MonoBehaviour
{
    ...
    internal static bool DisableButtons { get; private set; }
    internal static bool StraightPlay { get; private set; }
    ...
    private void ParseCommandLine()
    {
        ...
        for (int i = 1; i < m_commandLine.Length; i++)
        {
            ...
            else if (cliItem == "-hidebuttons")
            {
                DisableButtons = true;
                i++;
            }
            else if (cliItem == "-straightplay")
            {
                StraightPlay = true;
                i++;
            }
