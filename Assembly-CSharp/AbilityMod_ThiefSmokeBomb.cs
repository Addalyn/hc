...
public class AbilityMod_ThiefSmokeBomb : AbilityMod
{
	...
	protected override string ModSpecificAutogenDesc(AbilityData abilityData)
	{
		...
		desc += PropDescGroundFieldMod(m_smokeFieldInfoMod, "{ SmokeFieldInfo }", isValid ? thiefSmokeBomb.m_smokeFieldInfo : null);
		...
		return desc + PropDescBarrierMod(m_barrierDataMod, "{ BarrierData }", isValid ? thiefSmokeBomb.m_barrierData : null);
	}
}
