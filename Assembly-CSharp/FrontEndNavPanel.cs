...
public class FrontEndNavPanel : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (ClientBootstrap.DisableButtons)
        {
    ...
    IL_0072:
        ...
        UIManager.SetGameObjectActive(m_LootMatrixBtn, ClientBootstrap.DisableButtons ? false : shouldShow);
        UIManager.SetGameObjectActive(m_WatchBtn, false);
        UIManager.SetGameObjectActive(m_CashShopBtn, ClientBootstrap.DisableButtons ? false : shouldShow);
