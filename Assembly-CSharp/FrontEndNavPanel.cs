...
#if !VANILLA
        UIManager.SetGameObjectActive(m_LootMatrixBtn, HydrogenConfig.Get().DisableButtons ? false : shouldShow);
#else
        UIManager.SetGameObjectActive(m_LootMatrixBtn, shouldShow);
#endif
        UIManager.SetGameObjectActive(m_WatchBtn, false);
#if !VANILLA
        UIManager.SetGameObjectActive(m_CashShopBtn, HydrogenConfig.Get().DisableButtons ? false : shouldShow);
#else
        UIManager.SetGameObjectActive(m_LootMatrixBtn, shouldShow);
#endif
